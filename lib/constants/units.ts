...
export const LENGTH_UNITS: LengthUnit[] = [
  { name: "mi", scalar: 1, description: "1.609km" },
  { name: "km", scalar: 1 * 1.609, description: "0.62137119miles" },
  {
    name: "marathons",
    scalar: 1 / 42.195,
    spaceBefore: true,
  ...
  },
  {
    ...
    spaceBefore: true,
    description:
      "Distance a reindeer could travel without stopping to urinate (informally 7.5km)",
  },
  {
    name: "beard seconds",
    scalar: 2e11,
  ...
  },
  {
    ...
    scalar: 1 / 3935.74,
    spaceBefore: true,
    description: "3935.74km",
  },
  {
    name: "ICN -> NYC",
    scalar: 1 / 11054.58,
    spaceBefore: true,
    description: "11054.58km",
  },
  {
    name: "lunar distance",
    scalar: 1 / 384398,
  ...
  },
  {
    ...
    description:
      "Astronomical unit, the average distance from the Sun to Earth (149.6Mkm)",
  },
  {
    name: "parsec",
